...
| SQLite | Nhúng sẵn (không cần cài) |
...
> **Lưu ý:** Mỗi lần mở thêm một cửa sổ mới = thêm một client. Có thể chạy nhiều client cùng lúc để test realtime.
...
```
feat: thêm tính năng auto-bidding
fix: sửa race condition trong concurrent bidding  
test: thêm unit test cho AuctionService
